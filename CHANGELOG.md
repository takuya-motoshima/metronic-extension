...
- Added initialization function for the toggle button component.
    ...
    ![toggle-button.png](screencaps/2.0.28/toggle-button.png)
    ...
    initToggleButton(document.querySelector('#parent'));
    ```
...
- Fixed clipboard copy component to support metronic version 8.1.8.  
    Instructions and a demo can be found [here](https://takuya-motoshima.github.io/metronic-extension/clipboard.html).
...
- Add a component to toggle password visibility (initPasswordToggle).  
    The component is applied to input elements with the <code>data-show-password-toggle=&quot;true&quot;</code> attribute.  
